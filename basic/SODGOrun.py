...
class Runner(object):
    ...
    def __init__(self, params):
        ...
        self.p.regloss = False
        self.p.smoothloss = False
...
if __name__ == '__main__':
    ...
    parser.add_argument('-dropedge', dest='dropedge', action='store_true', help='whether to use non_linear function')
    parser.add_argument('-heads', dest='heads', action='store_true', help='whether to use non_linear function')
    parser.add_argument('-smoothloss', dest='smoothloss', action='store_true', help='whether to use smoothloss')
    parser.add_argument('-regloss', dest='regloss',action='store_false', help='whether to use smoothloss')
    parser.add_argument('-degree_norm', dest='degree_norm', action='store_true', help='whether to use degree_norm')
